...
import com.psurvivors.PTSGame.StateGame;
import com.psurvivors.callbacks.ChangeSpeechRecognizerCallback;
import com.psurvivors.callbacks.RequestActionCallback;
				...
				public void run() {
					...
					if (sr != null){
						if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN){
			 			...
			 			Toast.makeText(AndroidLauncher.this, "SR não disponivel para seu dispositivo!", Toast.LENGTH_SHORT).show();
					}
				}
			});
 		}
		...
		game.getScreen().changeMicrophone(Microphone.ERRO);
 		...
 		switch (error)
 		{
 			...
 			case SpeechRecognizer.ERROR_NO_MATCH:
 				message = "Sem comparações";
 		 		Toast.makeText(this, "Não entedi! Tente novamente", Toast.LENGTH_SHORT).show();
 				break;
