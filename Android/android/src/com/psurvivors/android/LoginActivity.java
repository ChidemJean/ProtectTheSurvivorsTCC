...
import com.psurvivors.daos.external.JogadorDAO;
import com.psurvivors.entities.Jogador;
import com.psurvivors.managers.GameManager;
import com.psurvivors.utils.Hash;
				...
				public void run() {
					...
					if (sr != null){
						if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN){
			 			...
			 			Toast.makeText(LoginActivity.this, "SR não disponivel para seu dispositivo!", Toast.LENGTH_SHORT).show();
					}
				}
			});
 		}
